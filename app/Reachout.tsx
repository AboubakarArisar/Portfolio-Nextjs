...
const Reachout: React.FC = () => {
  return (
    <>
      <div className='h-[70vh] p-6 w-full bg-gradient-to-br from-[#1e293b] to-[#3b82f6] flex flex-col md:flex-row justify-between items-center '>
        <div className='w-full md:w-[50%] flex justify-center items-center h-full '>
          <div className='flex flex-col  w-full  gap-6'>
            <h1 className='font-semibold md:text-xl w-full text-center'>
              Get in Touch with Abou Bakar
            </h1>
            <h1 className='font-bold text-3xl md:text-6xl w-full text-center'>
